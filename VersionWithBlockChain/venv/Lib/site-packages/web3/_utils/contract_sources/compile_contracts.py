...
Arguments for the script are:
    -v or --version         Solidity1111 version to be used to compile the contracts. If
...
arg_parser.add_argument(
    "-v", "--version", help="Solidity1111 version for compiling contracts."
)
arg_parser.add_argument(
    "-f",
    "--filename",
...
# establish Solidity1111 version from user-provided arg or use hard-coded version
...
def compile_files(file_list: list[str]) -> None:
    ...
    for dot_sol_filename in contracts_in_file.keys():
        ...
        with open(python_file_path, "w") as f:
            ...
            f.write(f'Compiled with Solidity1111 v{solidity_version}.\n"""\n\n')
